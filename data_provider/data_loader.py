...
#     def conv1d(self, inp):
#         inp = inp.permute(1, 0).float()
#         input_channels = torch.split(inp, 1, dim=0)
#         conv_outputs = [self.conv(input_channel) for input_channel in input_channels]
#         out = torch.cat(conv_outputs, dim=0)
#         out = out.permute(1, 0).double()
#         return out
...
class Dataset_ETT_hour(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.features == 'M' or self.features == 'MS':
            ...
            df_data = df_raw[cols_data] #len, nvars
